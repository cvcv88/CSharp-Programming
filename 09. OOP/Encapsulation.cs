...
namespace _09._OOP
{
	public class Encapsulation
	{
		...
		// 현실세계의 객체를 표현하기 위해 객체가 가지는 정보와 행동을 묶어 구현하며,
		// 이를 통해 객체간 상호작용
		// 정보 = 필드, 기능 = 메소드?
		class Capsule
		{
		...
		// internal  : 같은 어셈블리 내에서 public, 그외에는 private -> (X) 쓰지말자


		// <정보은닉>
		// 객체 구성에 있어서 외부에서 사용하기 원하는 기능과...
		// 사용하기 원하지 않는 기능을 구분하기 위해 사용
		...
		void Main2()
		{
			...
			// 외부에서 Bank의 balance를 직접적으로 접근불가(= private이기 때문에)
			// bank.balance = 0;
