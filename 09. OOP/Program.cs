namespace _09._OOP
{
	internal class Program
	{
		...
		class Player
		{
			...
			public void Attack(Monster monster) // 몬스터를 때림
			{
		...
		{
			public int hp = 50;
			public void TakeHit(int damage) // 맞아서 체력 깎임
			{
				hp -= damage;
			}
		}
		...
		static void Main1(string[] args)
		{
			...
			player.Attack(monster);     // 플레이어가 Attack이라는 행동으로 monster와 상호작용
			player.Use(potion);         // 플레이어가 Use 행동으로 potion과 상호작용
		}
	}
}